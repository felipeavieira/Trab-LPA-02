...
1.6. Os códigos fonte (.c) e executáveis (.exe) dos três programas estão no repositório do trabalho, 
nas pastas "Códigos-fonte (.c)" e " Executáveis (.exe)", respectivamente.

2. Programas no repositório 
